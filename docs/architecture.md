...
| Distribution | CI cross-compiles for six platforms and discards the output. No release and no installer; the only version string is the one `agenthub-mcp` reports at initialize. Step 10, #67 |
