...
| Distribution | CI cross-compiles for six platforms and discards the output. No release and no installer; the only version string a shipped binary reports is `agenthub-mcp`'s at initialize. Step 10, #67 |
